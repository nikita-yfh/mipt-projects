...
enum LogLevel {
  ...
  /*LOG_ERROR,      ///< Вывод необычных ошибок
	LOG_UERROR,     ///< Вывод странных ошибок
	LOG_IERROR,     ///< Вывод интересных ошибок
	LOG_WERROR,     ///< Вывод стремных ошибок
	LOG_IFERROR,    ///< Вывод прикольных ошибок, предшествующих фатальным ошибкам со стиранием всех данных
	LOG_THENERROR,  ///< Прикольный вывод обычных ошибок
	LOG_RIPERROR,   ///< Фатальный вывод обычных ошибок, со стиранием... ну вы поняли
	LOG_FUNNYRIPER, ///< Прикольный вывод фатальных ошибок, чтобы не было депрессии (Она все же случилась, имя не дописано.)
  */LOG_3AM_BC_ERR, ///< Вывод обычных ошибок с блинчиком с бананом и шоколадом в 3 часа ночи, чтобы не было... ну вы поняли.
