...
enum LogLevel {
	...
	LOG_FATAL,      ///< Вывод фатальных ошибок, после программа обычно аварийно завершается
	LOG_WTF,        ///< Вывод того, чего никогда не должно было произойти. По уровню схож с ассертом.
 ...
 * лога в HTML-файл (вставляет в него SVG), иначе выдает предупреждение.
 *
 * @param [in]		level		Уровень лога (LogLevel)
